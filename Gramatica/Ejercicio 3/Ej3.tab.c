...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ASEQ = 3,                       /* ASEQ  */
  YYSYMBOL_BSEQ = 4,                       /* BSEQ  */
  YYSYMBOL_NL = 5,                         /* NL  */
  YYSYMBOL_BAD = 6,                        /* BAD  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ASEQ", "BSEQ", "NL",
  "BAD", "$accept", "input", "line", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* line: ASEQ BSEQ NL  */
#line 23 "Ej3.y"
                   {
        printf("%s\n",
               forma_correcta((yyvsp[-2].s), (yyvsp[-1].s)) ? "Acepta" : "No acepta");
